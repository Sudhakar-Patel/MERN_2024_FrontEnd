...
const onSubmitHandler=async(e)=>{
  ...
  try{
    const api=await axios.post(`https://mern-1-usry.onrender.com/api/users/register`,{
      name,email,password
    },
    {
      headers:{
...
/>
  ...
  <div className="form-group">
    ...
    <input value={name}
      onChange={(e)=>setName(e.target.value)} type="text" className="form-control" id="name" aria-describedby="emailHelp" placeholder="Enter name"/>
